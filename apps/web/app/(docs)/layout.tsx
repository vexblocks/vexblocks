			...
			<div className="min-h-screen bg-background">
				...
				<div className="container max-w-screen-2xl flex-1 items-start md:grid md:grid-cols-[260px_minmax(0,1fr)] md:gap-8 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-10">
					...
					<main className="relative py-8 lg:gap-10 xl:grid xl:grid-cols-[1fr_280px]">
						<article className="prose prose-slate dark:prose-invert mx-auto w-full min-w-0 max-w-4xl px-4 prose-headings:text-foreground prose-li:text-muted-foreground prose-p:text-muted-foreground prose-p:leading-7 md:px-8 [&>*:not(:first-child)]:mt-6">
							{children}
						</article>
						<TableOfContents />
					</main>
