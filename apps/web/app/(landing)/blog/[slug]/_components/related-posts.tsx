...
export function RelatedPosts({
  ...
  const allPosts = useQuery(api.cms.content.listPublished, {
    ...
    limit: 4,
  }) as ContentLibraryContent[] | undefined;
  ...
  return (
    <section className="mt-8 border-gray-200 border-t pt-8 lg:mt-16 lg:pt-16">
      <div className="mx-auto max-w-7xl">
        <h2 className="mb-4 font-normal font-serif text-2xl text-gray-900 lg:mb-8 lg:text-3xl">
          Related Posts
        </h2>
