...
export default function HomePage() {
	return (
		<>
			{/* Hero Section */}
			<section className="bg-linear-to-b from-white to-blue-50 py-20 md:py-32">
				<Container>
					<div className="mx-auto max-w-4xl text-center">
						<Heading as="h1" size="6xl" className="mb-6">
							The Open Source Headless CMS
							<br />
							<span className="text-blue-600">Built for Convex</span>
						</Heading>
			...
			<section className="bg-white py-20">
				<Container>
					...
					<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
						{/* Feature 1 */}
						<div className="rounded-lg border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg">
				...
				<Container>
					...
					<div className="grid gap-8 md:grid-cols-3">
						<div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
							<div className="mb-2 font-bold text-blue-600 text-sm">GLOBAL</div>
						...
						<div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
							<div className="mb-2 font-bold text-blue-600 text-sm">PAGE</div>
							<Heading as="h3" className="mb-4 text-2xl">
								Unique Pages
							</Heading>
							<Text className="mb-6 text-gray-600">
						...
						<div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
							<div className="mb-2 font-bold text-blue-600 text-sm">
								COLLECTION
							</div>
							<Heading as="h3" className="mb-4 text-2xl">
								Multiple Instances
			...
			<section className="bg-blue-600 py-20 text-white">
				<Container>
					<div className="mx-auto max-w-3xl text-center">
						...
						<Text className="mb-8 text-blue-100 text-xl">
