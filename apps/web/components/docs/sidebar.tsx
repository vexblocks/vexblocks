		...
		return (
			<div className="pb-6">
				<button
					...
					className="mb-2 flex w-full items-center justify-between rounded-md px-3 py-2 font-semibold text-sm transition-colors hover:bg-accent/50"
				>
					{item.title}
					<ChevronDown
						className={cn(
				...
				{isOpen && (
					<div className="ml-3 space-y-0.5 border-border/40 border-l-2 pl-3">
	...
	return (
		<aside className="fixed top-16 z-30 hidden h-[calc(100vh-4rem)] w-full shrink-0 border-r bg-background md:sticky md:block">
			<div className="relative h-full overflow-y-auto px-6 py-8">
				<div className="pb-8">
					<h4 className="mb-4 px-3 font-semibold text-foreground/60 text-sm">
						Documentation
					</h4>
