...
export function Banner() {
	return (
		<>
			...
			>
				<span className="flex h-6.5 shrink-0 items-center justify-center gap-1 rounded-full bg-linear-to-r from-gray-700 to-gray-800 px-2.5 py-2 font-medium text-white leading-3.5">
					🎉 <span>News</span>
				</span>
			...
			<div className="hidden w-full flex-row items-center justify-center gap-4 overflow-hidden bg-gray-900 px-10 py-2 text-sm md:flex lg:px-20">
				<span className="flex h-6.5 shrink-0 items-center justify-center gap-1 rounded-full bg-linear-to-r from-gray-700 to-gray-800 px-2.5 py-2 font-medium text-white leading-3.5">
					🎉 <span>News</span>
				</span>
